...
useEffect(() => {
  setRetirementTotal(utils.retirementAmount(income, incomePeriod, savings, savingsPeriod, weeklySavings))
}, [compareCosts])

  return (
    <>
      <section className="section has-text-centered is-size-5 ">
        <p>A rule of thumb says that you can live off investment income when your total  investment is 25 x expenses.</p><i class="fa-solid fa-question" />
